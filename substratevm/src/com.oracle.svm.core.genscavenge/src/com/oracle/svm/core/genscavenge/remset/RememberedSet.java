...
public interface RememberedSet {
     ...
     */
    @AlwaysInline("GC performance")
    void dirtyCardForAlignedObject(Object object, boolean verifyOnly, DynamicHub objectHub, int typeID, int dirtyCounterType);
     ...
     */
    @AlwaysInline("GC performance")
    void dirtyCardForUnalignedObject(Object object, boolean verifyOnly, DynamicHub objectHub, int typeID, int dirtyCounterType);
