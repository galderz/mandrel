 ...
 * Heavily copied from {@link com.oracle.svm.core.genscavenge.PathExhibitor},
 * which is not accessible from here.
 * todo why is PathExhibitor not in core instead of genscavenge
 **/
final class PathToGcRoots {
    ...
    private static final class FindPathToObjectOperation extends JavaVMOperation {
        private final PathToGcRoots exhibitor;
        private final Object object;
        private final PathEdge result;

        FindPathToObjectOperation(PathToGcRoots exhibitor, Object object, PathEdge result) {
